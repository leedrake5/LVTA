...
lvta_data$Date <- as.Date(lvta_data$Date, format="%m/%d/%Y")
...
lvta_free_data$Date <- as.Date(lvta_free_data$Date, format="%m/%d/%Y")
...
lvta_margin_data$Date <- as.Date(lvta_margin_data$Date, format="%m/%d/%Y")
